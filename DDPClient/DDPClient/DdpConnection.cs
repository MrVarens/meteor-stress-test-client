...
namespace DdpClient
{
    public sealed class DdpConnection : IDisposable
    {
        ...
        public EJson.DdpDate UserTokenExires { get; private set; }
        ...
        public EventHandler<DdpMessage> Message;
        ...
        public void LoginWithUsernameSync(string username, string password)
        {
            var waiting = true;

            EventHandler<LoginResponse> login = (s, e) => waiting = false;
            Login += login;
        ...
        public void LoginWithEmailSync(string email, string password)
        {
            var waiting = true;
        ...
        public void LoginWithTokenSync(string token)
        {
            var waiting = true;
        ...
        public void CallSync(string name, Action<MethodResponse> callback, params object[] methodParams)
        {
            bool waiting = true;
        ...
        public MethodResponse CallSync(string name, params object[] methodParams)
        {
        ...
        public void CallSync<T>(string name, Action<DetailedError, T> callback, params object[] methodParams)
        {
            bool waiting = true;
        ...
        private void HandleLogin(MethodResponse response)
        {
            ...
            {
                UserToken = null;
                UserTokenExires = null;
            }
            else
            {
                UserToken = loginResponse.Token;
                UserTokenExires = loginResponse.TokenExpires;
            }
